        ...
        foreach ($arf_samples as $arf_sample) {
            ...
            <div class="arf_sample_container">
                <div class="arf_sample_title">
                    <a href="<?php echo $arf_sample['redirect_url']; ?>" target="_blank"><?php echo $arf_sample['name']; ?></a>
                </div>
                <div class="arf_sample_image">
                    <a href="javascript: void(0);" target="_blank"><img src="<?php echo $arf_sample['image']; ?>" width="290" height="119" data-arf-form-id="<?php echo $arf_sample['form_id']; ?>" /></a>
                </div>
